...
if(isset($_POST['btn-update'])){
 ...
 $update = "UPDATE users SET firstname='$firstname', lastname='$lastname',phone='$phone',email='$email',city='$city',province='$province',postalcode='$postalcode' WHERE id=". $_GET['edit_id'];
...
<label>First Name:</label><input type="text" name="firstname" placeholder="First Name" value="<?php echo $row['firstname']; ?>"><br/><br/>
<label>Last Name:</label><input type="text" name="lastname" placeholder="Last Name" value="<?php echo $row['lastname']; ?>"><br/><br/>
<label>Phone:</label><input type="text" name="phone" placeholder="Phone" value="<?php echo $row['phone']; ?>"><br/><br/>
<label>Email:</label><input type="text" name="email" placeholder="Email" value="<?php echo $row['email']; ?>"><br/><br/>
<label>City:</label><input type="text" name="city" placeholder="City" value="<?php echo $row['city']; ?>"><br/><br/>
<label>Province:</label><input type="text" name="province" placeholder="Province" value="<?php echo $row['province']; ?>"><br/><br/>
<label>Postal Code:</label><input type="text" name="postalcode" placeholder="Postal Code" value="<?php echo $row['postalcode']; ?>"><br/><br/>
