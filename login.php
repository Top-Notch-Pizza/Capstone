...
<input class="form-control" id="email" maxlength="50" name="email" type="email" required />
...
<input class="form-control" id="password" maxlength="50" name="password" type="password" required />
