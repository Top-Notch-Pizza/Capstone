...
if(isset($_POST['btn-update'])){
 ...
 $image= $_POST['image'];
 $update = "UPDATE pizza SET name='$name', category='$category',description='$description',image='$image' WHERE id=". $_GET['edit_id'];
...
<label>Image:</label><input type="text" name="image" placeholder="Image" value="<?php echo $row['image']; ?>"><br/><br/>
