...
if(isset($_GET['edit_id'])){
 $sql = "select * FROM pizza WHERE id =" .$_GET['edit_id'];
...
if(isset($_POST['btn-update'])){
 ...
 $image= $_POST['image'];
 $update = "delete from pizza WHERE id=". $_GET['edit_id'];
...
<label>Name:</label><input type="text" name="name" placeholder="Name" disabled value="<?php echo $row['name']; ?>"><br/><br/>
<label>Category:</label><input type="text" name="category" placeholder="Category" disabled value="<?php echo $row['category']; ?>"><br/><br/>
<label>Description:</label><input type="text" name="description" placeholder="Description" disabled value="<?php echo $row['description']; ?>"><br/><br/>
<label>Image:</label><input type="text" name="image" placeholder="Image" disabled value="<?php echo $row['image']; ?>"><br/><br/>
